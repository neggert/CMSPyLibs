...
class CMSDileptonEvent(CMSEvent):
    ...
    def __init__(self, eventid, vertices, electrons, muons, jets, met, triggerresults, triggernames):
        ...
        super(CMSDileptonEvent, self).__init__(eventid, vertices, electrons, muons, jets, met, triggerresults, triggernames)
